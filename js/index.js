...
// Iteration 3: Loops
let driverCapitalLetters = ""; 
for (var i = 0; i < hacker1.length; i++) {
    if (i > 0)
        driverCapitalLetters += " ";

    driverCapitalLetters += hacker1[i].toUpperCase();
}
console.log(`"${driverCapitalLetters}"`);

let navigatorReverseOrder = "";
for (var i = hacker2.length - 1; i >= 0; i--) {
    navigatorReverseOrder += hacker2[i];
}
console.log(`"${navigatorReverseOrder}"`);
